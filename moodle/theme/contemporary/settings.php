...
if ($ADMIN->fulltree) {
    ...
    $name = 'theme_contemporary/confirminfouser_regulations';
    $title = get_string('footer_regulations', 'theme_contemporary');
    $description = get_string('footer_regulations_desc', 'theme_contemporary');
    $setting = new admin_setting_confightmleditor($name, $title, $description, '');
    $settings->add($setting);
    
    $name = 'theme_contemporary/confirminfouser_guide';
    $title = get_string('footer_guide', 'theme_contemporary');
    $description = get_string('footer_guide_desc', 'theme_contemporary');
    $setting = new admin_setting_confightmleditor($name, $title, $description, '');
    $settings->add($setting);
