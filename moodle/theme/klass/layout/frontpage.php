...
<!-- Phone box -->
<div id="id4" data-toggle="modal" data-target="#myModal">
	<div id="id3"></div>
	<div id="id2"></div>
	<div id="id1">
		<i class="fa fa-phone fa-inverse" 
		style="font-size: 48px; margin-top: 11px;"></i>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content" >
			<div class="modal-header alert-success text-center">
			  <h4 class="modal-title">TRUNG TÂM CÔNG NGHỆ THÔNG TIN VÀ NGOẠI NGỮ MITECH</h4>
			</div>
...
<?php  //require_once(dirname(__FILE__) . '/includes/pop_up.php');  ?>
<!-- Custom Popup -->
