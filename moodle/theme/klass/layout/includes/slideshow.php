  ...
  <div id="home-page-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
     ...
     <?php for($s1=1;$s1<=$numberofslides;$s1++):
      ...
      <div class="item<?php echo $cls_txt2; ?>" style="background-image: url(<?php echo $slideimg; ?>);">
          <div class="carousel-overlay-content container-fluid">
            <div class="content-wrap">
              ...
              <a href="<?php echo $slideurl; ?>" class="read-more"><?php echo get_string('readmore','theme_klass'); ?>&nbsp; <i class="fa <?=$icon;?>"></i></a>
            </div>
          </div>
      </div>
      <?php endfor; ?>
      ...
      <a class="left carousel-control" href="#home-page-carousel" data-slide="prev"><i class="fa fa-caret-left" style="color:#009FE5;font-size:50px;"></i></a>
      <a class="right carousel-control" href="#home-page-carousel" data-slide="next"><i class="fa fa-caret-right" style="color:#009FE5;font-size:50px;"></i></a>
