 ...
 */
	...
	class block_slideshow_edit_form extends block_edit_form {
		protected function specific_definition($mform) {
			...
			$carousel = format_string(get_string('carousel', 'block_slideshow'));
			$flipHorz = format_string(get_string('flipHorz', 'block_slideshow'));
			$flipVert = format_string(get_string('flipVert', 'block_slideshow'));
			$scrollVert = format_string(get_string('scrollVert', 'block_slideshow'));
			$shuffle = format_string(get_string('shuffle', 'block_slideshow'));
			$tileSlide = format_string(get_string('tileSlide', 'block_slideshow'));
			$tileBlind = format_string(get_string('tileBlind', 'block_slideshow'));
